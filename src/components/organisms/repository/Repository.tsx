...
import { StyledImageContainer, StyledContentContainer, StyledContainer } from './Repository.styled';
    ...
    return (
        <CollectionItem>
            ...
            <div className="row">
                ...
                <div className="col s12">
                    <FlexContainer direction="row" justifyContent={'flex-start'} alignItems={'center'}>
